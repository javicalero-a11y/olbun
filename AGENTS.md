...
|                           |                                                                                                                                                             |
| ------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Milestones complete**   | M0 Foundation · M1 Identity & tenancy · M2 Audit & shell (bar i18n) · M3 Deadline engine · M4 Contracts · M5 Expedientes · M6 Communications · M7 Detection |
| **Milestone in progress** | M8 — Connected mailboxes. M9 documents and M10 risk/incidents already have working vertical slices, but are not complete.                                   |
...
| Coverage is ratcheted at the measured M6 baseline (56.79% lines, 55.73% functions, 49.08% branches, 57.58% statements), below SPEC's 80% target. New work must not lower it; M23 closes the remaining legacy service/action gap (ADR 0008)                                                                           | M23        |
...
| Forwarding aliases are implemented and protected by a provider-neutral inbound webhook, but public MX/domain routing still requires choosing and configuring an email provider                                                                                                                                       | M8         |
