...
| Text extraction covers text-based files only. PDFs, Word files and scans are recorded as unindexed and say so on screen; they need a parser and, for scans, OCR                                                                                                                                                                                                          | M9         |
| No retention purge, and no PDF index in the zip export — the index and chronology are Markdown                                                                                                                                                                                                                                                                           | M9         |
| No antivirus: uploads stay PENDIENTE and are labelled unscanned                                                                                                                                                                                                                                                                                                          | M9         |
| Deleting a document is not exposed anywhere; `bloqueadoPorLitigio` is stored and honoured by nothing yet because nothing deletes                                                                                                                                                                                                                                         | M9         |
