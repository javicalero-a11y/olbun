...
|                           |                                                                                                                                                                                                     |
| ------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Milestones complete**   | M0 Foundation · M1 Identity & tenancy · M2 Audit & shell (bar i18n) · M3 Deadline engine · M4 Contracts · M5 Expedientes · M6 Communications · M7 Detection · M8 Connected mailboxes · M9 Documents |
| **Milestone in progress** | M10 — Risks and incidents. A working vertical slice exists; reviews, residual scoring, controls and corrective-action UI remain.                                                                    |
...
| Coverage is ratcheted at the measured M9 baseline (62.85% lines, 62.84% functions, 52.40% branches, 63.01% statements), below SPEC's 80% target. New work must not lower it; M23 closes the remaining legacy service/action gap (ADR 0008)                                                                           | M23        |
