...
|                           |                                                                                                                                                                                                                               |
| ------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Milestones complete**   | M0 Foundation · M1 Identity & tenancy · M2 Audit & shell (bar i18n) · M3 Deadline engine · M4 Contracts · M5 Expedientes · M6 Communications · M7 Detection · M8 Connected mailboxes · M9 Documents · M10 Risks and incidents |
| **Milestone in progress** | M11 — Personal, convenio y adscripción. Implementation complete; final full-suite and clean-chain verification is pending because this Codex session cannot open local network ports after exhausting its approval quota.     |
...
| M11's focused unit and real-Postgres integration tests pass and its production build compiles. The final full E2E run, MinIO/ClamAV network tests and migration replay still need a session with permission to reach local ports; do not advance M11 to complete until that gate is green.                           | M11        |
